...
class HomePage extends React.Component {
  ...
  render() {
    const twitter= this.props.data.social ? this.props.data.social.twitter : ""
    const facebook= this.props.data.social ? this.props.data.social.facebook : ""
    const snapchat= this.props.data.social ? this.props.data.social.snapchat : ""
    const meta = {
      title: 'Cude CMS Test',
